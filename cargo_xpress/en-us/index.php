        ...
        <div id="revolution-slider">
            <ul>
                <li data-transition="fade" data-slotamount="7" data-masterspeed="2500" data-delay="5000">
                    <!--  BACKGROUND IMAGE -->
                    <img src="../img-rev-slider/panama2.jpg" alt="">
                    ...
                    <div class="tp-caption sfb text-left"
                         ...
                         data-start="1600"
                         data-easing="easeInOutCubic">
                        <a class="btn btn-slider " href="contact.php">Contact Us</a>&nbsp;&nbsp;<a class="btn btn-sold-slider" href="services.php">Services</a>
                    </div>
                </li>

                <li data-transition="fade" data-slotamount="7" data-masterspeed="2500" data-delay="5000">
                    <!--  BACKGROUND IMAGE -->
                    <img src="../img-rev-slider/envios-a-venezuela.jpg" alt="">
...
<!--                        Rapido y confiable.-->
                    ...
                    <div class="tp-caption sfb text-left"
                         ...
                         data-start="1600"
                         data-easing="easeInOutCubic">
                        <a class="btn btn-slider" href="contact.php">Contact Us</a>&nbsp;&nbsp;<a class="btn btn-border-slider" href="services.php">Services</a>
                    </div>
                </li>
                
                <li data-transition="fade" data-slotamount="7" data-masterspeed="2500" data-delay="5000">
                    <!--  BACKGROUND IMAGE -->
                    <img src="../img-rev-slider/china.jpg" alt="">
    ...
    <div class="box-container">
        <div id="bg-service-1" class="box-one-third light-text">
            <div class="inner wow" data-wow-delay="0s">
                <h2 class="wow fadeIn" data-wow-delay=".2s">Customs Management</h2>
                ...
                <a href="services.php" class="btn-border-light wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".3s">Services</a>
            </div>
        </div>
        ...
        <div id="bg-service-3" class="box-one-third light-text">
            <div class="inner">
                <h2 class="wow fadeIn" data-wow-delay=".4s">Air Cargo</h2>
                ...
                <div class="divider-single"></div>
                <a href="services.php" class="btn-border-light wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".3s">Services</a>
            </div>
        </div>

        <div id="bg-service-2" class="box-one-third light-text">
            <div class="inner">
                <h2 class="wow fadeIn" data-wow-delay=".6s">Ocean freight </h2>
                <!--<p class="wow fadeIn" data-wow-delay=".7s">Expertos en manejo de carga aérea, marítima y terrestre, pero sobre todo garantizándoles rapidez y seguridad a la hora de confiarnos su carga. </p>-->
                <div class="divider-single"></div>
                <a href="services.php" class="btn-border-light wow fadeInUp" data-wow-delay=".6s" data-wow-duration=".3s">Services</a>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="text-center">
                    <h2 class="wow fadeIn" data-wow-delay="0">Why choose us?
                        <span>Our Service is excellent, fast and personalized.</span>
                    </h2>
                    ...
                    <div class="col-md-6">
                        <div class="feature-box">
                            ...
                            <div class="text wow fadeIn" data-wow-delay=".4s">
                                <h3>Experience</h3>
                                <!--<p>Somos una compañía con más de 20 años de experiencia en el mercado brindando los más eficientes servicios aduanales dentro de los cuales ofrecemos los siguientes: Gestiones Aduanales, Asesoría, logística, manejo de carga aérea, marítima y terrestre, pero sobre todo garantizándoles rapidez y seguridad a la hora de confiarnos su carga.</p>-->
                            </div>
                        </div>
                    </div>
